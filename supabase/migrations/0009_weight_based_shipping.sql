-- =============================================================
-- Naz's Collection — 0009 Weight-based shipping on create_order
-- Base (1st kg): Karachi = 350 PKR, other cities = 450 PKR
-- Each extra kg: + half of the base rate
-- Weight is summed from products.weight (grams) × quantity
-- =============================================================
...
begin
  ...
  -- Billable kg: ceil(grams/1000), minimum 1 kg
  ...
  -- 1st kg = base; each extra kg = + base/2
