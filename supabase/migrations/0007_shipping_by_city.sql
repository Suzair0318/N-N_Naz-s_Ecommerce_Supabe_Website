-- =============================================================
-- Naz's Collection — 0007 City-based shipping on create_order
-- Karachi = 350 PKR, all other cities = 400 PKR
-- Run after 0004 (or replace create_order if already deployed).
-- =============================================================
...
begin
  ...
  -- Authoritative shipping fee (never trust the client).
  ...
  -- Persist the applied fee on the address payload for invoices/admin.
